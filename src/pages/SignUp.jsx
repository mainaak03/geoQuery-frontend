              ...
              <div className="flex flex-col flex-grow">
                ...
                <div className="flex flex-row z-10">
                  <div className="mx-4 my-2 font-light">
                    ...
                    <input id="firstname" type="text" className="block p-3 mt-1 rounded-lg bg-Primary bg-opacity-20" required />
                  </div>
                  <div className="mx-4 my-2 font-light">
                    <label htmlFor="lastname">Last Name</label>
                    <input id="lastname" type="text" className="block p-3 mt-1 rounded-lg bg-Primary bg-opacity-20" required />
                  </div>
                </div>
